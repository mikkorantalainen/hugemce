...
import * as LicenseKeyValidation from 'hugerte/core/init/LicenseKeyValidation';

describe('browser.hugerte.core.init.LicenseKeyValidationTest', () => {
  let oldWarn: typeof console.warn;
  let messages: string[] = [];
  const expectedLogMessage = 'You are running HugeRTE in evaluation mode. Provide a valid license key or specify the license to \'GPL\' to agree to the open source license terms. https://www.tiny.cloud/';

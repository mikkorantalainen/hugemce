...
gulp.task('copyHugerte', function(done) {
  if (fs.existsSync('../hugerte/js/hugerte/hugerte.min.js')) {
    ...
    console.log(chalk.red('Local HugeRTE does not exist. Using cloud version instead'));
    console.log(chalk.yellow('Run yarn build in the repository root to build a local version of HugeRTE'));
    const url = 'https://cdn.tiny.cloud/1/qagffr3pkuv17a8on1afax661irst1hbr4e6tbv888sz91jc/hugerte/5-dev/hugerte.min.js';
